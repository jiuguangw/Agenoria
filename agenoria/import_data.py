...
def import_data(config):
    ...
    # Import growth data
    growth_data = pd.read_csv(config['data_growth'], parse_dates=['Date'])
    hatch_data = pd.read_csv(config['data_weight'])
    ...
    return diaper_data, sleep_data, feeding_bottle_data, feeding_solid_data, misc_data, growth_data, hatch_data
